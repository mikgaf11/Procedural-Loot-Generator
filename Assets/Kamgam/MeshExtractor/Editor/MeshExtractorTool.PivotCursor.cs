...
namespace Kamgam.MeshExtractor
{
    partial class MeshExtractorTool
    {
        ...
        public void CenterPivotOnTriangles()
        {
        ...
        public void CenterPivotOnLocalOrigin()
        {
        ...
        {
            return LastSelectedObject.transform;
        }

        public void AlignPivotRotationWith(bool localSpace)
        {
            if (localSpace)
            {
                var root = GetSelectionRoot();
            ...
            {
                _cursorRotation = Quaternion.identity;
            }
        }
