...
namespace Kamgam.MeshExtractor
{
    ...
    /// 1) Add the 'BoneDataResolver' as a Component to your SkinnedMeshRenderer gameObject.<br />
    ...
    /// 5) Delete the 'BoneDataResolver'.<br />
    ...
    public class BoneDataResolver : MonoBehaviour
    {
        ...
        public bool Resolve()
        {
            if (BoneData != null && Renderer != null)
            {
                ...
                if (existingRootBone != null && existingRootBone.gameObject.activeSelf && existingRootBone.name == BoneData.RootName)
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_infoFoldout)
            {
                EditorGUILayout.HelpBox(new GUIContent(
                        ...
                        "1) Add the 'BoneDataResolver' as a Component to your SkinnedMeshRenderer gameObject.\n" +
                        "2) Drag in the BoneData asset into the BoneData slot.\n" +
                        "3) Make sure the original SkinnedMeshRenderer is nearby (sibling level in hierarchy).\n" +
                        "4) Hit the 'Resolve' button.\n" +
                        "5) Delete the 'BoneDataResolver'.\n" +
